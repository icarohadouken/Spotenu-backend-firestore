...
class BandBusiness {
    ...
    signup(name, nickname, description, password, email) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.bandDatabase.createBand(new Band_1.Band(id, name, nickname, description, hashPassword, false, email));
        });
    }
    getBands(token) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    authorizeBand(token, bandId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if ((checkBand === null || checkBand === void 0 ? void 0 : checkBand.getAuthorization()) === true) {
    ...
    login(nickname, password) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const band = yield this.bandDatabase.loginBand(nickname);
            if (!band) {
